...
def edit_video(video_path, color, new_path=None, delete_source=False):
    if not new_path:
        new_path = video_path
        delete_source = False
    ...
    with VideoFileClip(video_path) as my_clip:
        ...
        with AudioFileClip('utils/music/music_lower.mp3') as audio_background:
...
if __name__ == '__main__':
    edit_video('example_video.mp4', color=(255, 255, 0), new_path="test123.mp4")
